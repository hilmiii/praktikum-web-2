                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <div class="input-group">
                                ...
                                <input id="stok" name="stok" value="<?=$row['stok']?>" type="number"
                                    class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="jenis_produk" class="col-2 col-form-label">Jenis Produk</label>
                        <div class="col-10">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                </div>
                                <input id="jenis_produk" name="jenis_produk" value="<?=$row['jenis_produk']?>"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <div class="input-group">
                                ...
                                <input id="gambar" name="gambar" value="<?=$row['gambar']?>" type="file"
                                    class="form-control">
                            </div>
                        </div>
                    </div>
