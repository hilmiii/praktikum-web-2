    ...
    <div>
        ...
        <form method="GET" action="proses_nilai.php">
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <input id="uas" name="uas" placeholder="Masukkan Nilai UAS Anda..." type="text" class="form-control"
                        required="required">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-8">
                    <input id="praktikum" name="praktikum" placeholder="Masukkan Nilai Praktikum Anda..." type="text"
                        class="form-control" required="required">
                </div>
            </div>
            <div class="form-group row">
